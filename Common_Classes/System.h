...
public:
    ...
    void setDebugVals(int32_t val1 = SKIP_DBG_VAL,
                      ...
                      int32_t val7 = SKIP_DBG_VAL,
                      int32_t val8 = SKIP_DBG_VAL);
    void sendDebugVals();

private:
    bool systemDebuggingEnabled = true;
    int32_t systemDebugVal1 = 0;
    int32_t systemDebugVal2 = 0;
    int32_t systemDebugVal3 = 0;
    int32_t systemDebugVal4 = 0;
    int32_t systemDebugVal5 = 0;
    int32_t systemDebugVal6 = 0;
    int32_t systemDebugVal7 = 0;
    int32_t systemDebugVal8 = 0;
