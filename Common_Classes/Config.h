...
// Motors
#define CFG_PWM_INVERT					 false               // TivSeg: true, MiniSeg: false
...
// Controller
#define CFG_CTLR_UPDATE_FREQ             10
...
#define CFG_CTLR_MAXDUTY				 0.9				// Duty cycle needs to be limited to 0.9 for the H-bridges of the TivSeg. Value can be 1.0 for MiniSeg 
